...
export const vocabulary: VocabularyItem[] = [
  {
    ...
    example: 'The email looked like it was from my bank, but it was a phishing scam.',
  ...
  },
  {
    ...
    example: 'The message used urgency, claiming my account would be locked in 24 hours.',
  ...
  },
  {
    ...
    example: 'The sender address was a classic case of spoofing; the display name said Apple, but the email was completely random.',
  ...
  },
  {
    ...
    example: 'Never share your login credentials with anyone over chat.',
  ...
  },
  {
    ...
    example: 'The grammar mistakes in the official email made it look highly suspicious.',
  ...
  },
  {
    ...
    example: 'Always verify that a website is legitimate before entering your credit card details.',
  ...
  },
  {
    ...
    example: 'Opening the suspicious attachment installed malware on his laptop.',
  ...
  },
  {
    ...
    example: 'Please verify the sender\'s email address by hovering over their name.',
  ...
  },
  {
    ...
    example: 'The email started with a generic greeting, which was the first red flag.',
  ...
  },
  {
    ...
    example: 'The scammer used social engineering to convince the employee to reset the system password.',
