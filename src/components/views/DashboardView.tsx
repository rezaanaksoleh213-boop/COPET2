      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 z-10 relative print:block">
        ...
        <div className="lg:col-span-3 space-y-8 print:hidden">
          ...
          <div>
            ...
            <p className="text-slate-400 font-mono text-sm md:text-base border-l-2 border-teal-500 pl-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div 
              ...
              className="group bg-slate-900/60 hover:bg-slate-900/90 border border-slate-800 hover:border-teal-500/50 p-6 rounded-2xl cursor-pointer transition-all flex flex-col gap-4 shadow-lg backdrop-blur-sm"
            >
              <div className="w-12 h-12 bg-teal-500/10 rounded-xl flex items-center justify-center text-teal-400 group-hover:scale-110 group-hover:bg-teal-500/20 transition-all">
                <BookOpen className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-lg font-bold font-mono tracking-wide group-hover:text-teal-400 transition-colors mb-2">VOCAB DRILL</h3>
            ...
            <div 
              ...
              className="group bg-slate-900/60 hover:bg-slate-900/90 border border-slate-800 hover:border-orange-500/50 p-6 rounded-2xl cursor-pointer transition-all flex flex-col gap-4 shadow-lg backdrop-blur-sm"
            >
              <div className="w-12 h-12 bg-orange-500/10 rounded-xl flex items-center justify-center text-orange-500 group-hover:scale-110 group-hover:bg-orange-500/20 transition-all">
                <ShieldAlert className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-lg font-bold font-mono tracking-wide group-hover:text-orange-500 transition-colors mb-2">SCAM QUIZ</h3>
          ...
          <div className="bg-slate-950 border border-rose-500/30 p-5 rounded-xl shadow-inner relative overflow-hidden">
            ...
            <div className="font-mono text-sm text-slate-300 space-y-2 opacity-80">
              <p><span className="text-orange-400">[{new Date().toLocaleTimeString()}]</span> SYS_WARN: Indonesia menduduki peringkat ke-2 paling rawan penipuan daring (The Sumsuber).</p>
              <p><span className="text-orange-400">[{new Date().toLocaleTimeString()}]</span> INTEL: Total kerugian siber mencapai Rp 476 Miliar periode Nov 2024 - Jan 2025.</p>
              <p><span className="text-orange-400">[{new Date().toLocaleTimeString()}]</span> ALERT: 235 Juta pengguna internet nasional berpotensi menjadi target Social Engineering.</p>
            </div>
          </div>
        </div>

        {/* SISI KANAN (SIDEBAR VERTICAL) */}
        <div className="lg:col-span-1 flex flex-col gap-5 print:hidden">
          
          {/* AGENT PROFILE */}
          <div className="bg-slate-900/60 border border-teal-500/30 p-5 rounded-2xl backdrop-blur-sm text-center relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-1 bg-teal-500/50 shadow-[0_0_10px_rgba(45,212,191,0.8)]" />
            ...
            <div className="w-16 h-16 bg-slate-950 border-2 border-teal-500/50 rounded-full mx-auto mb-3 flex items-center justify-center text-teal-400 shadow-[0_0_15px_rgba(45,212,191,0.2)]">
          ...
          <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-2xl backdrop-blur-sm text-center">
            ...
            <div className="text-4xl font-black text-orange-500 font-mono tracking-tighter">
              {userPoints} <span className="text-sm text-orange-500/50">PTS</span>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-2">
              {achievements.length > 0 ? (
                achievements.map((ach) => (
                  <div key={ach} className="w-full text-center font-bold font-mono bg-teal-500/10 border border-teal-500/30 text-teal-300 px-3 py-2 rounded text-xs shadow-sm">
                    {ach}
                  </div>
                ))
              ) : (
